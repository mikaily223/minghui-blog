...
button.bg-\\[var\\(--primary\\)\\] {
    ...
    border: none;
}</style>`,1);function _r(o,r){qa(r,!1);const x="/minghui-blog/";let u=S(!1),f=S(!1),c=S(!1),T=S(!1),P=S(0),F=S(0),m=S(.7),y=S(!1),w=S(!1),z=S(!1),C=S(0),A=S(""),h=S(!1),E=S({title:"示例歌曲",artist:"示例艺术家",cover:`${x}favicon/favicon-light-192.png`,url:"",duration:0}),d=S([]),k=S(0),a=S(),H=S(),J=S();const dt=[{id:1,title:"幸せの記憶",artist:"未知艺术家",cover:"assets/music/cover/hitori.jpg",url:"assets/music/url/幸せの記憶.mp3",duration:240}];function bt(){!t(a)||!t(E).url||(t(u)?t(a).pause():t(a).play())}function V(){v(f,!t(f)),t(f)&&(v(T,!1),v(c,!1))}function O(){v(c,!t(c)),t(c)&&(v(f,!1),v(T,!1))}function Qt(){v(T,!t(T))}function We(){v(z,!t(z))}function Ne(){v(C,(t(C)+1)%3)}function De(){if(t(d).length<=1)return;const l=t(k)>0?t(k)-1:t(d).length-1;gt(l)}function Pt(){if(t(d).length<=1)return;let l;if(t(z))do l=Math.floor(Math.random()*t(d).length);while(l===t(k)&&t(d).length>1);else l=t(k)<t(d).length-1?t(k)+1:0;gt(l)}function gt(l){if(l<0||l>=t(d).length)return;const B=t(u);v(k,l),t(a)&&t(a).pause(),Zt(t(d)[t(k)]),(B||!t(u))&&setTimeout(()=>{t(a)&&(t(a).readyState>=2?t(a).play().catch(()=>{}):t(a).addEventListener("canplay",()=>{t(a).play().catch(()=>{})},{once:!0}))},100)}function ht(l){return l.startsWith("http://")||l.startsWith("https://")||l.startsWith("/")?l:`/${l}`}function Zt(l){!l||!t(a)||(v(E,{...l}),l.url?(v(w,!0),t(a).pause(),D(a,t(a).currentTime=0),v(P,0),v(F,l.duration??0),t(a).removeEventListener("loadeddata",te),t(a).removeEventListener("error",ee),t(a).removeEventListener("loadstart",ae),t(a).addEventListener("loadeddata",te,{once:!0}),t(a).addEventListener("error",ee,{once:!0}),t(a).addEventListener("loadstart",ae,{once:!0}),D(a,t(a).src=ht(l.url)),t(a).load()):v(w,!1))}function te(){v(w,!1),t(a)?.duration&&t(a).duration>1&&(v(F,Math.floor(t(a).duration)),t(d)[t(k)]&&D(d,t(d)[t(k)].duration=t(F)),D(E,t(E).duration=t(F)))}function ee(l){v(w,!1),Ct(`无法播放 "${t(E).title}"，正在尝试下一首...`),t(d).length>1?setTimeout(()=>Pt(),1e3):Ct("播放列表中没有可用的歌曲")}function ae(){}function Ct(l){v(A,l),v(h,!0),setTimeout(()=>{v(h,!1)},3e3)}function Oe(){v(h,!1)}function Ye(l){if(!t(a)||!t(H))return;const B=t(H).getBoundingClientRect(),xt=(l.clientX-B.left)/B.width*t(F);D(a,t(a).currentTime=xt),v(P,xt)}function qe(l){if(!t(a)||!t(J))return;const B=t(J).getBoundingClientRect(),Q=Math.max(0,Math.min(1,(l.clientX-B.left)/B.width));v(m,Q),D(a,t(a).volume=t(m)),v(y,t(m)===0)}function re(){t(a)&&(v(y,!t(y)),D(a,t(a).muted=t(y)))}function ie(l){if(!Number.isFinite(l)||l<0)return"0:00";const B=Math.floor(l/60),Q=Math.floor(l%60);return`${B}:${Q.toString().padStart(2,"0")}`}function Ue(){t(a)&&(t(a).addEventListener("play",()=>{v(u,!0)}),t(a).addEventListener("pause",()=>{v(u,!1)}),t(a).addEventListener("timeupdate",()=>{v(P,t(a).currentTime)}),t(a).addEventListener("ended",()=>{t(C)===1?(D(a,t(a).currentTime=0),t(a).play().catch(()=>{})):t(C)===2||t(k)<t(d).length-1||t(z)?Pt():v(u,!1)}),t(a).addEventListener("error",l=>{v(w,!1)}),t(a).addEventListener("stalled",()=>{}),t(a).addEventListener("waiting",()=>{}))}Ca(()=>{v(a,new Audio),D(a,t(a).volume=t(m)),Ue(),v(d,[...dt]),t(d).length>0?Zt(t(d)[0]):Ct("本地播放列表为空")}),$a(()=>{t(a)&&(t(a).pause(),D(a,t(a).src=""))}),za();var ne=tt(),Ke=G(ne);{var He=l=>{var B=cr(),Q=G(B);{var xt=e=>{var g=ir(),L=n(g),M=n(L);b(M,{icon:"material-symbols:error",class:"text-xl flex-shrink-0"});var j=p(M,2),s=n(j,!0);i(j);var Y=p(j,2),ot=n(Y);b(ot,{icon:"material-symbols:close",class:"text-lg"}),i(Y),i(L),i(g),Ft(()=>U(s,t(A))),_("click",Y,Oe),I(e,g)};$(Q,e=>{t(h)&&e(xt)})}var $t=p(Q,2);let se;var at=n($t);let oe;var Xe=n(at);{var Ge=e=>{b(e,{icon:"eos-icons:loading",class:"text-white text-lg"})},Je=e=>{var g=tt(),L=G(g);{var M=s=>{var Y=nr();I(s,Y)},j=s=>{b(s,{icon:"material-symbols:music-note",class:"text-white text-lg"})};$(L,s=>{t(u)?s(M):s(j,!1)},!0)}I(e,g)};$(Xe,e=>{t(w)?e(Ge):e(Je,!1)})}i(at);var rt=p(at,2);let le;var ce=n(rt),zt=n(ce),At=n(zt);let de;var ve=p(At,2),Ve=n(ve);{var Qe=e=>{b(e,{icon:"eos-icons:loading",class:"text-white text-xl"})},Ze=e=>{var g=tt(),L=G(g);{var M=s=>{b(s,{icon:"material-symbols:pause",class:"text-white text-xl"})},j=s=>{b(s,{icon:"material-symbols:play-arrow",class:"text-white text-xl"})};$(L,s=>{t(u)?s(M):s(j,!1)},!0)}I(e,g)};$(Ve,e=>{t(w)?e(Qe):e(Ze,!1)})}i(ve),i(zt);var It=p(zt,2),Rt=n(It),ta=n(Rt,!0);i(Rt);var ue=p(Rt,2),ea=n(ue,!0);i(ue),i(It);var fe=p(It,2),yt=n(fe),aa=n(yt);b(aa,{icon:"material-symbols:visibility-off",class:"text-lg"}),i(yt);var Bt=p(yt,2),ra=n(Bt);b(ra,{icon:"material-symbols:expand-less",class:"text-lg"}),i(Bt),i(fe),i(ce),i(rt);var _t=p(rt,2);let pe;var Wt=n(_t),Nt=n(Wt),me=n(Nt);let be;i(Nt);var Dt=p(Nt,2),Ot=n(Dt),ia=n(Ot,!0);i(Ot);var Yt=p(Ot,2),na=n(Yt,!0);i(Yt);var ge=p(Yt,2),sa=n(ge);i(ge),i(Dt);var he=p(Dt,2),wt=n(he),oa=n(wt);b(oa,{icon:"material-symbols:visibility-off",class:"text-lg"}),i(wt);var qt=p(wt,2),la=n(qt);b(la,{icon:"material-symbols:expand-more",class:"text-lg"}),i(qt),i(he),i(Wt);var Ut=p(Wt,2),it=n(Ut),ca=n(it);i(it),Ce(it,e=>v(H,e),()=>t(H)),i(Ut);var Kt=p(Ut,2),nt=n(Kt);let xe;var da=n(nt);b(da,{icon:"material-symbols:shuffle",class:"text-lg"}),i(nt);var vt=p(nt,2),va=n(vt);b(va,{icon:"material-symbols:skip-previous",class:"text-xl"}),i(vt);var st=p(vt,2);let ye;var ua=n(st);{var fa=e=>{b(e,{icon:"eos-icons:loading",class:"text-xl"})},pa=e=>{var g=tt(),L=G(g);{var M=s=>{b(s,{icon:"material-symbols:pause",class:"text-xl"})},j=s=>{b(s,{icon:"material-symbols:play-arrow",class:"text-xl"})};$(L,s=>{t(u)?s(M):s(j,!1)},!0)}I(e,g)};$(ua,e=>{t(w)?e(fa):e(pa,!1)})}i(st);var ut=p(st,2),ma=n(ut);b(ma,{icon:"material-symbols:skip-next",class:"text-xl"}),i(ut);var kt=p(ut,2);let _e;var ba=n(kt);{var ga=e=>{b(e,{icon:"material-symbols:repeat-one",class:"text-lg"})},ha=e=>{var g=tt(),L=G(g);{var M=s=>{b(s,{icon:"material-symbols:repeat",class:"text-lg"})},j=s=>{b(s,{icon:"material-symbols:repeat",class:"text-lg opacity-50"})};$(L,s=>{t(C)===2?s(M):s(j,!1)},!0)}I(e,g)};$(ba,e=>{t(C)===1?e(ga):e(ha,!1)})}i(kt),i(Kt);var we=p(Kt,2),Et=n(we),xa=n(Et);{var ya=e=>{b(e,{icon:"material-symbols:volume-off",class:"text-lg"})},_a=e=>{var g=tt(),L=G(g);{var M=s=>{b(s,{icon:"material-symbols:volume-down",class:"text-lg"})},j=s=>{b(s,{icon:"material-symbols:volume-up",class:"text-lg"})};$(L,s=>{t(m)<.5?s(M):s(j,!1)},!0)}I(e,g)};$(xa,e=>{t(y)||t(m)===0?e(ya):e(_a,!1)})}i(Et);var Z=p(Et,2),wa=n(Z);i(Z),Ce(Z,e=>v(J,e),()=>t(J));var Lt=p(Z,2);let ke;var ka=n(Lt);b(ka,{icon:"material-symbols:queue-music",class:"text-lg"}),i(Lt),i(we),i(_t);var Ea=p(_t,2);{var La=e=>{var g=lr(),L=n(g),M=n(L),j=n(M,!0);i(M);var s=p(M,2),Y=n(s);b(Y,{icon:"material-symbols:close",class:"text-lg"}),i(s),i(L);var ot=p(L,2);Ha(ot,5,()=>t(d),Xa,(ft,X,W)=>{var q=or();let Tt;var pt=n(q),Ta=n(pt);{var Sa=N=>{b(N,{icon:"material-symbols:graphic-eq",class:"text-[var(--primary)] animate-pulse"})},Ma=N=>{var Mt=tt(),Gt=G(Mt);{var Jt=lt=>{b(lt,{icon:"material-symbols:pause",class:"text-[var(--primary)]"})},Pa=lt=>{var Me=sr();Me.textContent=W+1,I(lt,Me)};$(Gt,lt=>{W===t(k)?lt(Jt):lt(Pa,!1)},!0)}I(N,Mt)};$(Ta,N=>{W===t(k)&&t(u)?N(Sa):N(Ma,!1)})}i(pt);var Ht=p(pt,2),Ee=n(Ht);i(Ht);var Le=p(Ht,2),St=n(Le);let Te;var Fa=n(St,!0);i(St);var Xt=p(St,2);let Se;var ja=n(Xt,!0);i(Xt),i(Le),i(q),Ft((N,Mt,Gt,Jt)=>{Tt=R(q,1,"playlist-item flex items-center gap-3 p-3 hover:bg-[var(--btn-plain-bg-hover)] cursor-pointer transition-colors",null,Tt,N),et(q,"aria-label",`播放 ${t(X).title??""} - ${t(X).artist??""}`),et(Ee,"src",Mt),et(Ee,"alt",t(X).title),Te=R(St,1,"font-medium truncate",null,Te,Gt),U(Fa,t(X).title),Se=R(Xt,1,"text-sm text-[var(--content-meta)] truncate",null,Se,Jt),U(ja,t(X).artist)},[()=>({"bg-[var(--btn-plain-bg)]":W===t(k),"text-[var(--primary)]":W===t(k)}),()=>ht(t(X).cover),()=>({"text-[var(--primary)]":W===t(k),"text-90":W!==t(k)}),()=>({"text-[var(--primary)]":W===t(k)})]),_("click",q,()=>gt(W)),_("keydown",q,N=>{(N.key==="Enter"||N.key===" ")&&(N.preventDefault(),gt(W))}),I(ft,q)}),i(ot),i(g),Ft(ft=>U(j,ft),[()=>Ja(Ga.playlist)]),_("click",s,Qt),er(3,g,()=>rr,()=>({duration:300,axis:"y"})),I(e,g)};$(Ea,e=>{t(T)&&e(La)})}i($t),Ua(2),Ft((e,g,L,M,j,s,Y,ot,ft,X,W,q,Tt,pt)=>{se=R($t,1,"music-player fixed bottom-4 right-4 z-50 transition-all duration-300 ease-in-out",null,se,e),oe=R(at,1,"orb-player w-12 h-12 bg-[var(--primary)] rounded-full shadow-lg cursor-pointer transition-all duration-500 ease-in-out flex items-center justify-center hover:scale-110 active:scale-95",null,oe,g),le=R(rt,1,"mini-player card-base bg-[var(--float-panel-bg)] shadow-xl rounded-2xl p-3 transition-all duration-500 ease-in-out",null,le,L),et(At,"src",M),de=R(At,1,"w-full h-full object-cover transition-transform duration-300",null,de,j),U(ta,t(E).title),U(ea,t(E).artist),pe=R(_t,1,"expanded-player card-base bg-[var(--float-panel-bg)] shadow-xl rounded-2xl p-4 transition-all duration-500 ease-in-out",null,pe,s),et(me,"src",Y),be=R(me,1,"w-full h-full object-cover transition-transform duration-300",null,be,ot),U(ia,t(E).title),U(na,t(E).artist),U(sa,`${ft??""} / ${X??""}`),et(it,"aria-valuenow",t(F)>0?t(P)/t(F)*100:0),Fe(ca,`width: ${t(F)>0?t(P)/t(F)*100:0}%`),xe=R(nt,1,"w-10 h-10 rounded-lg",null,xe,W),nt.disabled=t(d).length<=1,vt.disabled=t(d).length<=1,ye=R(st,1,"btn-regular w-12 h-12 rounded-full",null,ye,q),st.disabled=t(w),ut.disabled=t(d).length<=1,_e=R(kt,1,"w-10 h-10 rounded-lg",null,_e,Tt),et(Z,"aria-valuenow",t(m)*100),Fe(wa,`width: ${t(m)*100}%`),ke=R(Lt,1,"btn-plain w-8 h-8 rounded-lg",null,ke,pt)},[()=>({expanded:t(f),"hidden-mode":t(c)}),()=>({"opacity-0":!t(c),"scale-0":!t(c),"pointer-events-none":!t(c)}),()=>({"opacity-0":t(f)||t(c),"scale-95":t(f)||t(c),"pointer-events-none":t(f)||t(c)}),()=>ht(t(E).cover),()=>({spinning:t(u)&&!t(w),"animate-pulse":t(w)}),()=>({"opacity-0":!t(f),"scale-95":!t(f),"pointer-events-none":!t(f)}),()=>ht(t(E).cover),()=>({spinning:t(u)&&!t(w),"animate-pulse":t(w)}),()=>ie(t(P)),()=>ie(t(F)),()=>({"btn-regular":t(z),"btn-plain":!t(z)}),()=>({"opacity-50":t(w)}),()=>({"btn-regular":t(C)>0,"btn-plain":t(C)===0}),()=>({"text-[var(--primary)]":t(T)})]),_("click",at,O),_("keydown",at,e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),O())}),_("click",yt,$e(O)),_("click",Bt,$e(V)),_("click",rt,V),_("keydown",rt,e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),V())}),_("click",wt,O),_("click",qt,V),_("click",it,Ye),_("keydown",it,e=>{if(e.key==="Enter"||e.key===" "){e.preventDefault(),t(H).getBoundingClientRect();const L=.5*t(F);t(a)&&(D(a,t(a).currentTime=L),v(P,L))}}),_("click",nt,We),_("click",vt,De),_("click",st,bt),_("click",ut,Pt),_("click",kt,Ne),_("click",Et,re),_("click",Z,qe),_("keydown",Z,e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),e.key==="Enter"&&re())}),_("click",Lt,Qt),I(l,B)};$(Ke,l=>{l(He)})}I(o,ne),Ya()}export{_r as default};
